...
public class ArchitecturalConstraintCheck extends CustomCheck {
    ...
    /**
     * Limpa os atributos da instância. Esse método deve ser executado sempre que for iniciada a análise de um novo
     * arquivo, pois a instância é a mesma para todas as análises (mesmo de arquivos diferentes). A análise de um novo
     * arquivo pode ser identificada através do TokenType.PACKAGE_DEF, que ocorre sempre na primeira linha do arquivo.
     */
    ...
    public void visitToken(DetailAST ast) {
        ...
        // log(ast.getLineNo(), MSG_TIPO_INVALIDO);
        // } else {
